...
from ramain.views.widgets.color import Color
from ramain.views.widgets.files_view import FilesView
from ramain.views.widgets.collapse_button import CollapseButton
from ramain.views.widgets.preprocessing_methods import PreprocessingMethods
from ramain.views.widgets.spectral_map import SpectralMapGraph
from ramain.views.widgets.spectral_plot import SpectralPlot
...
class ManualPreprocessing(QFrame):
    ...
    def __init__(self, parent: QWidget = None) -> None:
        ...
        self.icon = QIcon("ramain/resources/icons/monitor.svg")
    ...
    def init_file_error_widget(self) -> None:
        ...
        self.file_error.setWindowIcon(QIcon("ramain/resources/icons/message.svg"))
