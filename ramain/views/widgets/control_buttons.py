...
class ControlButtons(QFrame):
    ...
    def __init__(self, parent: QWidget = None):
        ...
        buttons = [
            QPushButton(icon=QIcon("ramain/resources/icons/collapse.svg")),
            QPushButton(icon=QIcon("ramain/resources/icons/maximize.svg")),
            QPushButton(icon=QIcon("ramain/resources/icons/exit.svg")),
        ]
