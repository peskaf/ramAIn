...
class AutoExportComponentsGraphics(QFrame):
    """
    ...
    def __init__(self, parent: QWidget = None) -> None:
        ...
        grid_layout.addWidget(QLabel("Export Components [graphics]"), 0, 0)
    ...
    def function_name(self) -> str:
        ...
        return Data.auto_export_graphics.__name__
    ...
    def get_string_name(self) -> str:
        ...
        return "Export Components [graphics]"
