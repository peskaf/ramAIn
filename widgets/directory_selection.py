...
class DirectorySelection(QWidget):
    ...
    def __init__(self, registry_value: Union[str, None] = None, parent: QWidget = None) -> None:
    ...
    def _change_directory(self) -> None:
        ...
        temp_dir = QFileDialog.getExistingDirectory(self, "Select Directory", self.directory)
